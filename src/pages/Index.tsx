      ...
      <main className="container mx-auto px-4 py-8 flex-grow">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col">
            <Card className="shadow-sm border overflow-hidden flex-grow">
              <CardHeader className="bg-muted/30 pb-3">
                <div className="flex items-center gap-2">
              ...
              <CardContent className="flex-grow">
                <Tabs defaultValue="bills" className="w-full h-full flex flex-col">
                  ...
                  <TabsContent value="bills" className="mt-0 focus-visible:outline-none focus-visible:ring-0 flex-grow">
                    {selectedBill ? (
                  ...
                  <TabsContent value="add" className="mt-0 focus-visible:outline-none focus-visible:ring-0 flex-grow">
                    <BillForm 
                      participants={participants}
                      onAddBill={addBill}
                    />
