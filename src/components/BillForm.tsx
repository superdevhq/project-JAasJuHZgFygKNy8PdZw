...
import { Bill, BillItem, Participant, Split } from '@/types';
...
import { X, Plus, Receipt, DollarSign } from 'lucide-react';
...
export function BillForm({ participants, onAddBill }: BillFormProps) {
